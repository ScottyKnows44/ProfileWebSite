function Resume(){
    ...
    Eagle Scout leadership, dedicated hard worker.
                </div>
            </div>
            ...
            <div>
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li>Present/ Demo work weekly, and incorporate client feedback into the product.</li>
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li>Built website using PHP, My SQL, Bootstrap, including user authentication and lead generation “Contact Us” form.</li>
                        <li>Completed project in five two-week sprints to get client feedback and evolve the design to the client's satisfaction.</li>
                        <li>Site won a local design competition and is actively used by client</li>
                    </ul>
                </div>
                <div>
            ...
            <div className="pb-5">
                ...
                <div>Coding Bootcamp in Software Development (JavaScript and SQL)</div>
            </div>
